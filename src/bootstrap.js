...
function uninstall(params, reason)
{
  ...
  if (reason == ADDON_UNINSTALL)
  {
    ...
    Services.prefs.clearUserPref("extensions.adsidebar.currentVersion");
  }
}
  ...
  if (!(module in scopes))
  {
    if (module == "info")
    {
      ...
      scopes[module].exports =
      {
        ...
        // adblockplus specific
        abp_addonID: "{d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d}",
        abp_addonVersion: "2.7.1.4130",
        abp_addonRoot: addonData.resourceURI.spec,
        abp_addonName: "adblockplus",
