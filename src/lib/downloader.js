...
Downloader.prototype =
{
  ...
  {
    let {abp_addonName, abp_addonVersion, application, applicationVersion, platform, platformVersion} = require("info");
    ...
    if (downloadCount > 4)
      downloadCount = "4+";
    url += "addonName=" + encodeURIComponent(abp_addonName) +
        "&addonVersion=" + encodeURIComponent(abp_addonVersion) +
